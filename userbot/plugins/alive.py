...
if ALIVE_PIC is None:
    PM_iMG = "https://te.legra.ph/file/53867f8ac256afce63ef2.jpg"
else:
    PM_iMG = ALIVE_PIC
...
if HELL_PIC is None:
    HELL_IMG = "https://te.legra.ph/file/53867f8ac256afce63ef2.jpg"
else:
    HELL_IMG = HELL_PIC

CAT_IMGE = os.environ.get("CAT_IMGE", None)
if CAT_IMGE is None:
    CAT_IMG = "https://te.legra.ph/file/53867f8ac256afce63ef2.jpg"
else:
    CAT_IMG = CAT_IMGE
...
catversion = "3.0"
ALIVE_MSG = Config.ALIVE_MSG or "𝗛𝗶𝗲𝗲 𝗜 𝗮𝗺 𝗠𝗮𝘁𝗿𝗶𝘅 𝘂𝘀𝗲𝗿𝗯𝗼𝘁 . 🅑🅔🅢🅣 🅤🅢🅔🅡🅑🅞🅣 🅦🅘🅣🅗 450 🅐🅜🅐🅩🅘🅝🅖 🅟🅛🅤🅖🅘🅝🅢😍
...
┣  𝗛𝗮𝘁𝘀 𝗼𝗳𝗳 𝘁𝗼 𝗺𝘆 𝗰𝗲𝗼 𝘄𝗵𝗼 𝗺𝗮𝗱𝗲 𝗺𝗲 

┣  𝗜 𝗽𝗿𝗼𝘃𝗶𝗱𝗲 𝗭-𝗹𝗲𝘃𝗲𝗹 𝘀𝗲𝗰𝘂𝗿𝗶𝘁𝘆 𝘁𝗼 𝗺𝘆 𝗺𝗮𝘀𝘁𝗲𝗿 

┣ 𝗧𝗼 𝗸𝗻𝗼𝘄 𝗺𝗼𝗿𝗲 𝗮𝗯𝗼𝘂𝘁 𝗺𝘆 𝗺𝗮𝘀𝘁𝗲𝗿 𝗷𝗼𝗶𝗻 - @𝗔𝗯𝗼𝘂𝘁_𝗦𝘁𝗲𝗳𝗳𝗲𝗻999
...
©️ 𝗖𝗼𝗽𝘆𝗿𝗶𝗴𝗵𝘁 𝗯𝘆 𝗪𝗧𝗙 𝗰𝗹𝗮𝗻 .

𝗨𝘀𝗲 𝗺𝗲 𝗶𝗻 𝘆𝗼𝘂𝗿 𝗼𝘄𝗻 𝗿𝗶𝘀𝗸 

𝗢𝗻𝗹𝘆 𝗱𝗲𝗽𝗹𝗼𝘆𝗮𝗯𝗹𝗲 𝘁𝗼 𝗰𝗹𝗮𝗻 𝗺𝗲𝗺𝗯𝗲𝗿𝘀 💫"
EMOJI = Config.CUSTOM_ALIVE_EMOJI or "  ✥ "
hellversion = "7.0"
# 🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔
DEFAULTUSER = str(ALIVE_NAME) if ALIVE_NAME else "Matrix userbot"
...
async def amireallyalive(salive):
    ...
    if ALIVE_PHOTTO:
        pm_caption = "**𝗛𝗶𝗲𝗲 𝗜 𝗮𝗺 𝗠𝗮𝘁𝗿𝗶𝘅 𝘂𝘀𝗲𝗿𝗯𝗼𝘁 . 🅑🅔🅢🅣 🅤🅢🅔🅡🅑🅞🅣 🅦🅘🅣🅗 450 🅐🅜🅐🅩🅘🅝🅖 🅟🅛🅤🅖🅘🅝🅢😍
...
𝗢𝗻𝗹𝘆 𝗱𝗲𝗽𝗹𝗼𝘆𝗮𝗯𝗹𝗲 𝘁𝗼 𝗰𝗹𝗮𝗻 𝗺𝗲𝗺𝗯𝗲𝗿𝘀 💫**\n"
        ...
        return
    req = requests.get("https://te.legra.ph/file/53867f8ac256afce63ef2.jpg")
...
pm_caption += "⚠️CHANNEL⚠️   : [ᴊᴏɪɴ](https://t.me/STEFFEN_BOTS)\n"

pm_caption += "🔥CREATOR🔥    : [Nub Here](https://t.me/STEFFEN999)\n\n"
...
CUSTOM_ALIVE = (
    Var.CUSTOM_ALIVE
    if Var.CUSTOM_ALIVE
    else "𝗛𝗶𝗲𝗲 𝗜 𝗮𝗺 𝗠𝗮𝘁𝗿𝗶𝘅 𝘂𝘀𝗲𝗿𝗯𝗼𝘁 . 🅑🅔🅢🅣 🅤🅢🅔🅡🅑🅞🅣 🅦🅘🅣🅗 450 🅐🅜🅐🅩🅘🅝🅖 🅟🅛🅤🅖🅘🅝🅢😍
